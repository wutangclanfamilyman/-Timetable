<?php  
	...
	while($row = mysqli_fetch_array($result)) {
    	...
    	if ($today < $date) {
    		echo "<div class='numbersWindow'><button id='number' data-toggle='tab' href='#timetable' value='".$row["ID"]."' onclick='ShowDirection(value);'>".$row["Num"]."</button><span class='time-start'> в  ".$date."</span><input type='hidden' id='dirNumber' value='".$dir."'></div>";
    		break;
    		}
		}
		if ($time["Finish"] != null) {
